...
export default new Vuex.Store({
  state: {
    ...
    routes: [
      { id: 1, wall_id: 1, name: 'Slappy McCracken', grade: '5.10b', height: '30ft', style: 'sport', description: 'The oldest climbing route in Ohio. Very busy during the weekend.' },
      { id: 2, wall_id: 1, name: 'Knope We Can', grade: '5.7', height: '25ft', style: 'sport',description: 'Est quid nostre papadio.Lorem ipsum quod maximus manatee. \n A climb in the classic Northhampton style. \n Old granite so watch your step!.' },
      { id: 3, wall_id: 2, name: 'Chain Mail Hula Skirt', grade: '5.7', height: '25ft', style: 'trad',description: 'Est quid nostre papadio.The raccoons are notorious here. \n Avoid in winter.' },
      { id: 4, wall_id: 2, name: 'Excellent Ella', grade: '5.6', height: '25ft', style: 'sport',description: 'Est quid nostre papadio. Several portholes available. \n Avoid in Spring.'},
      { id: 5, wall_id: 3, name: 'Digitalis', grade: '5.11d', height: '25ft', style: 'sport',description: 'Est quid nostre papadio.' },
      { id: 6, wall_id: 3, name: 'Chin Chimney', grade: '5.8', height: '25ft', style: 'sport',description: 'Est quid nostre papadio.' },
      { id: 7, wall_id: 4, name: 'Send Me On My Way', grade: '5.9', height: '75ft', style: 'sport',description: 'Est quid nostre papadio.' },
      { id: 8, wall_id: 4, name: 'Rat Stew', grade: '5.10a', height: '75ft', style: 'sport',description: 'Est quid nostre papadio.' },
      { id: 9, wall_id: 5, name: 'Nasty Wieners', grade: '5.10a', height: '65ft', style: 'sport',description: 'Est quid nostre papadio.' },
      { id: 10, wall_id: 5, name: 'Infatuation', grade: '5.7', height: '60ft', style: 'sport',description: 'n/a' },
      { id: 11, wall_id: 6, name: 'Katz Corner', grade: '5.6', height: '35ft', style: 'sport',description: 'n/a' },
      { id: 12, wall_id: 6, name: 'Silver Streaks', grade: '5.9', height: '60ft', style: 'sport',description: 'n/a' },
